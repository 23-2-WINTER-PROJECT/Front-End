              ...
              <div className="main-section">
                <div className="text-container">
                  <p className="Text">
                    ...
                    이제 걱정 없이 <span className="bold-text">소중한 순간들을 공유하세요.</span><br/><br/>
                    <span className = "im-Text">Mos-<span className="highlighted-text">AI</span>c,</span> <br/>
                    <span className = "imm-Text">개인의 사생활을 보호하는 강력한 첫 걸음.</span>
                  </p>
                </div>
                <div className="main-image-container">
                  <img src={mainImage} alt="Main Image" className="main-image" style={{ filter: `blur(${blurValue}px)` }} />
                </div>
              </div>
              <Slider
                value={blurValue}
